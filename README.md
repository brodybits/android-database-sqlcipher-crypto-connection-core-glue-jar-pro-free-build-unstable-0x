...
based on [`https://github.com/brodybits/android-database-sqlcipher-crypto-connection-core-glue-jar-build`](https://github.com/brodybits/android-database-sqlcipher-crypto-connection-core-glue-jar-build), which is in turn based on [`github:sqlcipher/android-database-sqlcipher`](https://github.com/sqlcipher/android-database-sqlcipher), with `android.database.sqlite` C++ and Java classes removed

with SCCoreGlue API pro-free support built from the JNI/NDK source in: [`github:brodybits/sqlite-fake-crypto-batch-connection-core-pro-free-2020-01`](https://github.com/brodybits/sqlite-fake-crypto-batch-connection-core-pro-free-2020-01)
